...
var ProductTypeORM = (function () {
    ...
    ProductTypeORM.prototype.createProduct = function (accesorio) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var error_2;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4, this.findProductByid(accesorio.id)];
                    case 1:
                        if (_a.sent())
                            throw 'Producto ya registrado';
                        return [4, (0, typeorm_1.getRepository)(accesorio_1.Accesorio).save(accesorio)];
    ...
    ProductTypeORM.prototype.updateProduct = function (accesorio) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (findProductByid !== undefined && accesorio.id !== findProductByid.id) {
    ...
    ProductTypeORM.prototype.deleteProduct = function (accesorio) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var error_5;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
