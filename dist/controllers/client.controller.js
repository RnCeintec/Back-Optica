...
var client_2 = require("../core/interactor/client");
    ...
    return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4, (0, client_2.createClientInteractor)(cliente)];
            case 1:
                result = _c.sent();
    ...
    return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 3, , 4]);
                _a = req.body, rz_social = _a.rz_social, direccion = _a.direccion, documento = _a.documento, telefono = _a.telefono, observacion = _a.observacion, tipo_documento = _a.tipo_documento;
                return [4, (0, typeorm_1.getRepository)(client_1.Client).findOne(req.params.id)];
            case 1:
                cliente = _c.sent();
                if (!cliente) {
                ...
                return [4, (0, client_2.updateClientInteractor)(cliente)];
            case 2:
                result = _c.sent();
                return [2, res.json({ result: result })];
            case 3:
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4, (0, client_2.deleteClientInteractor)(clientById)];
            case 2:
                result = _b.sent();
                return [2, res.json({ result: result })];
            case 3:
    ...
    return tslib_1.__generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                skip = hateoas.skip;
                where = { isActive: true };
                return [4, (0, typeorm_1.getRepository)(client_1.Client).findAndCount({
                        take: take,
                        skip: skip * take,
                        where: [
