...
import { ClientFactura } from "./client_factura";
...
export class Sales {
  ...
  //cliente factura
  @ManyToOne(() => ClientFactura, (clientesFactura) => clientesFactura.ventas)
  clientesFactura!: ClientFactura;

  //cliente
  @ManyToOne(() => Client, (clientes) => clientes.ventas)
  clientes!: Client;

  @ManyToOne(() => Vendedor, (vendedores) => vendedores.ventas)
  vendedores!: Vendedor;
